...
public class PictureController {
     ...
     */
    @PostMapping("/upload")
    public BaseResponse<PictureVO> upload (@RequestPart("file") MultipartFile multipartFile, PictureUploadRequest pictureUploadRequest, HttpServletRequest request) {
